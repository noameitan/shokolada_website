<?php /* Smarty version Smarty-3.1.14, created on 2013-09-25 12:25:35
         compiled from "E:\wamp\www\prestashop\themes\simpleresponsivetheme\modules\productcomments\productcomments.tpl" */ ?>
<?php /*%%SmartyHeaderCode:285255242ac0f18bd81-77923172%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '47e577c9d27ee31c1f481f64d270bacf466dbdf1' => 
    array (
      0 => 'E:\\wamp\\www\\prestashop\\themes\\simpleresponsivetheme\\modules\\productcomments\\productcomments.tpl',
      1 => 1378796580,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '285255242ac0f18bd81-77923172',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5242ac0f3f8f96_13287283',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5242ac0f3f8f96_13287283')) {function content_5242ac0f3f8f96_13287283($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'E:\\wamp\\www\\prestashop\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
"><?php echo smartyTranslate(array('s'=>'Report abuse','mod'=>'productcomments'),$_smarty_tpl);?>
	...
	<?php }else{ ?>
		...
		<p class="align_center">
			<a id="new_comment_tab_btn" class="open-comment-form"><?php echo smartyTranslate(array('s'=>'Be the first to write your review','mod'=>'productcomments'),$_smarty_tpl);?>
 !</a>
		</p>
		<?php }else{ ?>
...
'></input>
				...
				<p class="fr">
					<button id="submitNewMessage" class="button radius" name="submitMessage" type="submit"><?php echo smartyTranslate(array('s'=>'Send','mod'=>'productcomments'),$_smarty_tpl);?>
</button>&nbsp;
					<?php echo smartyTranslate(array('s'=>'or','mod'=>'productcomments'),$_smarty_tpl);?>
&nbsp;<a href="#" onclick="$('#new_comment_form').trigger('reveal:close');"><?php echo smartyTranslate(array('s'=>'Cancel','mod'=>'productcomments'),$_smarty_tpl);?>
</a>
				</p>
				<div class="clearfix"></div>
			</div>
