...
')"/>
    ...
    <div id="pb-right-column" class="six columns">
        <div class="<?php if (isset($_smarty_tpl->tpl_vars['images']->value)&&count($_smarty_tpl->tpl_vars['images']->value)>1){?>row<?php }?>">
...
" <?php if ($_smarty_tpl->tpl_vars['mediumSize']->value){?>height="<?php echo $_smarty_tpl->tpl_vars['mediumSize']->value['height'];?>
" width="<?php echo $_smarty_tpl->tpl_vars['mediumSize']->value['width'];?>
"<?php }else{ ?>height="58" width="58"<?php }?> />
                                            </a>
                                        </li>
                                        <?php } ?>
                                    <?php }?>
...
" onclick="$('span#wrapResetImages').hide('slow');return (false);"><?php echo smartyTranslate(array('s'=>'Display all pictures'),$_smarty_tpl);?>
            ...
            <?php }?>
            <!-- product img-->
            <div id="image-block" class="<?php if (isset($_smarty_tpl->tpl_vars['images']->value)&&count($_smarty_tpl->tpl_vars['images']->value)>1){?>ten columns<?php }?>">
                <?php if ($_smarty_tpl->tpl_vars['have_image']->value){?>
                    <span id="view_full_size">
                        <img src="<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['cover']->value['id_image'],'product_resp');?>
...
" <?php }?> id="bigpic" width="480" height="480" />
                    </span>
                <?php }else{ ?>
                    <span id="view_full_size">
...
<!-- noam, display the name and desc on the left-->
        <div id="product-information">
            <h1 id="product-title" itemprop="name"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->name, 'htmlall', 'UTF-8');?>
</h1>
        </div>
...
<!--
			    <?php if ($_smarty_tpl->tpl_vars['product']->value->on_sale){?>
                            ...
                            <?php }elseif($_smarty_tpl->tpl_vars['product']->value->specificPrice&&$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction']&&$_smarty_tpl->tpl_vars['productPriceWithoutRedution']->value>$_smarty_tpl->tpl_vars['productPrice']->value){?>
                                <span class="advert"><?php echo smartyTranslate(array('s'=>'Reduced price!'),$_smarty_tpl);?>
</span>
                            <?php }?>
-->
                            <?php if ($_smarty_tpl->tpl_vars['product']->value->online_only){?>
                                <span class="advert online_only"><?php echo smartyTranslate(array('s'=>'Online only'),$_smarty_tpl);?>
</span>
                            <?php }?>
                        </p>
...
<?php }?></span></p>
                    ...
                    <?php if (count($_smarty_tpl->tpl_vars['packItems']->value)&&$_smarty_tpl->tpl_vars['productPrice']->value<$_smarty_tpl->tpl_vars['product']->value->getNoPackPrice()){?>
                        <p class="pack_price old_price">
                            <span><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['product']->value->getNoPackPrice()),$_smarty_tpl);?>
</span>
                        </p>
                    <?php }?>
                        ...
                        <p id="availability_statut"<?php if (($_smarty_tpl->tpl_vars['product']->value->quantity<=0&&!$_smarty_tpl->tpl_vars['product']->value->available_later&&$_smarty_tpl->tpl_vars['allow_oosp']->value)||($_smarty_tpl->tpl_vars['product']->value->quantity>0&&!$_smarty_tpl->tpl_vars['product']->value->available_now)||!$_smarty_tpl->tpl_vars['product']->value->available_for_order||$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?> style="display: none;"<?php }?>>
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['product']->value->quantity<=0){?>
                                <?php if ($_smarty_tpl->tpl_vars['allow_oosp']->value){?>
                                    <span id="availability_value" class="warning_inline" itemprop="availability" content="preorder"><?php echo $_smarty_tpl->tpl_vars['product']->value->available_later;?>
</span>
                                <?php }else{ ?>
                                    <span id="availability_value" class="warning_inline" itemprop="availability" content="out_of_stock"><?php echo smartyTranslate(array('s'=>'This product is no longer in stock'),$_smarty_tpl);?>
</span>
                                <?php }?>
                            <?php }else{ ?>
                                <span id="availability_value" itemprop="availability" content="in_stock"><?php echo $_smarty_tpl->tpl_vars['product']->value->available_now;?>
</span>
                            <?php }?>
                        </p>
                    </div>
...
<?php }?>
            ...
            <?php if (($_smarty_tpl->tpl_vars['product']->value->show_price&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value))||isset($_smarty_tpl->tpl_vars['groups']->value)||$_smarty_tpl->tpl_vars['product']->value->reference||(isset($_smarty_tpl->tpl_vars['HOOK_PRODUCT_ACTIONS']->value)&&$_smarty_tpl->tpl_vars['HOOK_PRODUCT_ACTIONS']->value)){?>
                <!-- add to cart form-->
                <form id="buy_block" class="custom<?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value&&!isset($_smarty_tpl->tpl_vars['groups']->value)&&$_smarty_tpl->tpl_vars['product']->value->quantity>0){?> hidden<?php }?>" action="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('cart');?>
" method="post">
...
" class="has-tip tip-top color_pick<?php if (($_smarty_tpl->tpl_vars['group']->value['default']==$_smarty_tpl->tpl_vars['id_attribute']->value)){?> selected<?php }?>" style="background: <?php echo $_smarty_tpl->tpl_vars['colors']->value[$_smarty_tpl->tpl_vars['id_attribute']->value]['value'];?>
...
<br/>
                        ...
                        <div id="add_to_cart_row">
                            <div class="row">
                                <!-- quantity wanted -->
                                <p class="six columns mobile-two" id="quantity_wanted_p"<?php if ((!$_smarty_tpl->tpl_vars['allow_oosp']->value&&$_smarty_tpl->tpl_vars['product']->value->quantity<=0)||$_smarty_tpl->tpl_vars['virtual']->value||!$_smarty_tpl->tpl_vars['product']->value->available_for_order||$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?> style="display: none;"<?php }?>>
