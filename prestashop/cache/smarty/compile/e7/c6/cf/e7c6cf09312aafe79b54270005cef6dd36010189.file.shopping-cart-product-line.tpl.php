<?php /* Smarty version Smarty-3.1.14, created on 2013-10-20 15:43:34
         compiled from "E:\wamp\www\prestashop\themes\simpleresponsivetheme\shopping-cart-product-line.tpl" */ ?>
<?php /*%%SmartyHeaderCode:127415263de06045f19-95803904%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e7c6cf09312aafe79b54270005cef6dd36010189' => 
    array (
      0 => 'E:\\wamp\\www\\prestashop\\themes\\simpleresponsivetheme\\shopping-cart-product-line.tpl',
      1 => 1378796580,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '127415263de06045f19-95803904',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5263de066d5b98_30871788',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5263de066d5b98_30871788')) {function content_5263de066d5b98_30871788($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'E:\\wamp\\www\\prestashop\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
<?php if (!empty($_smarty_tpl->tpl_vars['product']->value['gift'])){?>_gift<?php }?>" class="<?php if (isset($_smarty_tpl->tpl_vars['productLast']->value)&&$_smarty_tpl->tpl_vars['productLast']->value&&(!isset($_smarty_tpl->tpl_vars['ignoreProductLast']->value)||!$_smarty_tpl->tpl_vars['ignoreProductLast']->value)){?>last_item<?php }elseif(isset($_smarty_tpl->tpl_vars['productFirst']->value)&&$_smarty_tpl->tpl_vars['productFirst']->value){?>first_item<?php }?> <?php if (isset($_smarty_tpl->tpl_vars['customizedDatas']->value[$_smarty_tpl->tpl_vars['productId']->value][$_smarty_tpl->tpl_vars['productAttributeId']->value])&&$_smarty_tpl->tpl_vars['quantityDisplayed']->value==0){?>alternate_item<?php }?> cart_item address_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_address_delivery']);?>
 <?php if ($_smarty_tpl->tpl_vars['odd']->value){?>odd<?php }else{ ?>even<?php }?>">
    <td class="cart_product table-hide-small">
...
"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value['attributes'], 'htmlall', 'UTF-8');?>
    ...
    <td class="cart_ref table-hide-small"><?php if ($_smarty_tpl->tpl_vars['product']->value['reference']){?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value['reference'], 'htmlall', 'UTF-8');?>
<?php }else{ ?>--<?php }?></td>
    <td class="cart_unit table-hide-small">
...
<?php }?>
    ...
    <?php if (!isset($_smarty_tpl->tpl_vars['noDeleteButton']->value)||!$_smarty_tpl->tpl_vars['noDeleteButton']->value){?>
        <td class="cart_delete table-hide-small">
