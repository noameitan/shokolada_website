<?php /* Smarty version Smarty-3.1.14, created on 2013-11-06 15:05:14
         compiled from "E:\wamp\www\prestashop\modules\opc\tpl\shopping-cart-product-line.tpl" */ ?>
<?php /*%%SmartyHeaderCode:29768527a3e8a0dac02-22199750%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f439611c3bc8fedb2e814e5a6da98494a1e68015' => 
    array (
      0 => 'E:\\wamp\\www\\prestashop\\modules\\opc\\tpl\\shopping-cart-product-line.tpl',
      1 => 1382356142,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '29768527a3e8a0dac02-22199750',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_527a3e8a802e28_14741391',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_527a3e8a802e28_14741391')) {function content_527a3e8a802e28_14741391($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'E:\\wamp\\www\\prestashop\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
"><img src="<?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['image_type']->value;?>
<?php $_tmp1=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],$_tmp1);?>
...
<td class="cart_ref" style="display:none"><?php if ($_smarty_tpl->tpl_vars['product']->value['reference']){?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value['reference'], 'htmlall', 'UTF-8');?>
<?php }else{ ?>--<?php }?></td>
...
<?php $_tmp4=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add&amp;id_product=".$_tmp2."&amp;ipa=".$_tmp3."&amp;id_address_delivery=".$_tmp4."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value));?>
...
<?php $_tmp7=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add&amp;id_product=".$_tmp5."&amp;ipa=".$_tmp6."&amp;id_address_delivery=".$_tmp7."&amp;op=down&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value));?>
...
<?php $_tmp10=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete&amp;id_product=".$_tmp8."&amp;ipa=".$_tmp9."&amp;id_address_delivery=".$_tmp10."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value));?>
"><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
...
" class="icon" width="11" height="13" /></a>
	...
	<td class="cart_unit" style="display: none">
...
<?php }?>
	...
	<?php if (!isset($_smarty_tpl->tpl_vars['noDeleteButton']->value)||!$_smarty_tpl->tpl_vars['noDeleteButton']->value){?>
		<td class="cart_delete" style="display: none">
		<?php if ((!isset($_smarty_tpl->tpl_vars['customizedDatas']->value[$_smarty_tpl->tpl_vars['productId']->value][$_smarty_tpl->tpl_vars['productAttributeId']->value])||$_smarty_tpl->tpl_vars['quantityDisplayed']->value)>0&&empty($_smarty_tpl->tpl_vars['product']->value['gift'])){?>
			<div>
				<a rel="nofollow" class="cart_quantity_delete" id="<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product'];?>
_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product_attribute'];?>
...
<?php $_tmp13=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete&amp;id_product=".$_tmp11."&amp;ipa=".$_tmp12."&amp;id_address_delivery=".$_tmp13."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value));?>
