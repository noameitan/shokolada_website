<?php /* Smarty version Smarty-3.1.14, created on 2013-10-20 15:43:32
         compiled from "E:\wamp\www\prestashop\themes\simpleresponsivetheme\shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:158815263de04c40132-14184985%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '55a50d52313d935004bdb1d54ba214b9271d2be4' => 
    array (
      0 => 'E:\\wamp\\www\\prestashop\\themes\\simpleresponsivetheme\\shopping-cart.tpl',
      1 => 1378796580,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '158815263de04c40132-14184985',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5263de05ba0222_75300774',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5263de05ba0222_75300774')) {function content_5263de05ba0222_75300774($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'E:\\wamp\\www\\prestashop\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
<div id="order-detail-content" class="table_block">
    <table id="cart_summary" class="table_responsive">
        <thead>
            <tr>
                <th class="cart_product first_item table-hide-small"><?php echo smartyTranslate(array('s'=>'Product'),$_smarty_tpl);?>
</th>
                <th class="cart_description item"><?php echo smartyTranslate(array('s'=>'Description'),$_smarty_tpl);?>
</th>
                <th class="cart_ref item table-hide-small"><?php echo smartyTranslate(array('s'=>'Ref.'),$_smarty_tpl);?>
</th>
                <th class="cart_unit item table-hide-small"><?php echo smartyTranslate(array('s'=>'Unit price'),$_smarty_tpl);?>
</th>
                ...
                <th class="cart_delete last_item table-hide-small">&nbsp;</th>
            </tr>
        </thead>
        <tfoot>
...
">
                ...
                <td class="table-hide-small"></td>
                <td class="cart_discount_price table-hide-small"><span class="price-discount">
...
<?php }?></span>
                ...
                <td class="price_discount_del table-hide-small">
...
<?php }?>" class="exclusive standard-checkout button radius" title="<?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
"><?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
 &raquo;</a>
        <?php if (Configuration::get('PS_ALLOW_MULTISHIPPING')){?>
            <a href="<?php if ($_smarty_tpl->tpl_vars['back']->value){?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,'step=1&amp;back={$back}');?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,'step=1');?>
<?php }?>&amp;multi-shipping=1" class="multishipping-button multishipping-checkout exclusive button radius" title="<?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
"><?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
 &raquo;</a>
        <?php }?>
    <?php }?>
...
<?php }?>" class="button_large button radius" title="<?php echo smartyTranslate(array('s'=>'Continue shopping'),$_smarty_tpl);?>
