<?php /* Smarty version Smarty-3.1.14, created on 2013-10-21 21:13:23
         compiled from "E:\wamp\www\prestashop\themes\simpleresponsivetheme\authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2145352657cd3316c81-36285462%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '970df7777a23dedcd034de00eb6f125db896e545' => 
    array (
      0 => 'E:\\wamp\\www\\prestashop\\themes\\simpleresponsivetheme\\authentication.tpl',
      1 => 1378796580,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2145352657cd3316c81-36285462',
  'function' => 
  array (
  ),
  'variables' => 
  array (
    ...
    'onr_phone_at_least' => 0,
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_52657cd41423a0_87412559',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52657cd41423a0_87412559')) {function content_52657cd41423a0_87412559($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'E:\\wamp\\www\\prestashop\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
<h1 style="margin-bottom: 0px;"><?php if (!isset($_smarty_tpl->tpl_vars['email_create']->value)){?><?php echo smartyTranslate(array('s'=>'Log in'),$_smarty_tpl);?>
...
" method="post" id="login_form" class="six columns">
            <fieldset>
...
"><?php echo smartyTranslate(array('s'=>'Forgot your password?'),$_smarty_tpl);?>
        ...
        <form action="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication',true);?>
" method="post" id="create-account_form" class="six columns">
            <fieldset>
...
<?php }?>" class="account_input" /></span>
                    ...
                    <p class="submit">
                        <?php if (isset($_smarty_tpl->tpl_vars['back']->value)){?><input type="hidden" class="hidden" name="back" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['back']->value, 'htmlall', 'UTF-8');?>
" /><?php }?>
                        <input type="button" id="SubmitCreate" name="SubmitCreate" class="button_large button radius" value="<?php echo smartyTranslate(array('s'=>'Create your account'),$_smarty_tpl);?>
" />
...
" method="post" id="new_account_form" class="">
        <fieldset>
...
<?php }?>" />
                <p class="form_info"><?php echo smartyTranslate(array('s'=>'DNI / NIF / NIE'),$_smarty_tpl);?>
</p>
            </p>
        </fieldset>
        ...
        <p class="cart_navigation required submit">
            ...
            <input type="submit" class="exclusive button radius" name="submitGuestAccount" id="submitGuestAccount" value="<?php echo smartyTranslate(array('s'=>'Continue'),$_smarty_tpl);?>
">
        </p>
    </form>
    <?php }?>
...
?>
    ...
    <?php }?>-->
<form action="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication',true);?>
" method="post" id="account-creation_form" class="">
    <div class="row">
        <div class="six columns">
...
<?php }?>" />
 ...
 <sup>*</sup></label>
                    ...
                    <p class="form_info"><?php echo smartyTranslate(array('s'=>'(5 characters min.)'),$_smarty_tpl);?>
</p>
                </p>
                <p class="select">
                    <label><?php echo smartyTranslate(array('s'=>'Date of Birth'),$_smarty_tpl);?>
...
<?php }?></textarea>
                ...
                <?php if ($_smarty_tpl->tpl_vars['onr_phone_at_least']->value){?>
...
<?php }?>" />
 ...
 <?php if ($_smarty_tpl->tpl_vars['onr_phone_at_least']->value){?><sup>*</sup><?php }?></label>
