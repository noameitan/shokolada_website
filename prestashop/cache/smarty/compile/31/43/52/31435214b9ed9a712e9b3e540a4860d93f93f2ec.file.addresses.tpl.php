<?php /* Smarty version Smarty-3.1.14, created on 2013-09-27 01:12:56
         compiled from "E:\wamp\www\prestashop\themes\simpleresponsivetheme\addresses.tpl" */ ?>
<?php /*%%SmartyHeaderCode:134085244b168d945b0-92665503%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '31435214b9ed9a712e9b3e540a4860d93f93f2ec' => 
    array (
      0 => 'E:\\wamp\\www\\prestashop\\themes\\simpleresponsivetheme\\addresses.tpl',
      1 => 1378796580,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '134085244b168d945b0-92665503',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5244b16919de75_34297981',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5244b16919de75_34297981')) {function content_5244b16919de75_34297981($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include 'E:\\wamp\\www\\prestashop\\tools\\smarty\\plugins\\function.counter.php';
if (!is_callable('smarty_modifier_replace')) include 'E:\\wamp\\www\\prestashop\\tools\\smarty\\plugins\\modifier.replace.php';
if (!is_callable('smarty_modifier_escape')) include 'E:\\wamp\\www\\prestashop\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
?>
        <li class="address">
            <h4 class="address_title"><?php echo $_smarty_tpl->tpl_vars['address']->value['object']['alias'];?>
</h4>
...
"<?php }?>>
            ...
            <?php } ?>
            <p class="actions">
                <a class="address_update" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['address']->value['object']['id']);?>
...
">&raquo; <?php echo smartyTranslate(array('s'=>'Update'),$_smarty_tpl);?>
                ...
                <br />
                <a class="address_delete" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['address']->value['object']['id']);?>
...
" class="button radius button_large"><?php echo smartyTranslate(array('s'=>'Add an address'),$_smarty_tpl);?>
</a></div>
