...
{if !isset($email_create)}
    ...
    <div class="row">
        ...
        <form action="{$link->getPageLink('authentication', true)}" method="post" id="create-account_form" class="six columns">
            <fieldset>
    ...
    <form action="{$link->getPageLink('authentication', true, NULL, "back=$back")}" method="post" id="new_account_form" class="">
        <fieldset>
        ...
        <fieldset class="account_creation dni">
            ...
            <p class="required text">
                ...
                <p class="form_info">{l s='DNI / NIF / NIE'}</p>
            </p>
        </fieldset>
        ...
        <p class="cart_navigation required submit">
            ...
            <input type="submit" class="exclusive button radius" name="submitGuestAccount" id="submitGuestAccount" value="{l s='Continue'}">
        </p>
    </form>
    {/if}
{else}
    ...
    {/if}-->
<form action="{$link->getPageLink('authentication', true)}" method="post" id="account-creation_form" class="">
    <div class="row">
        <div class="six columns">
	...
	*}
    ...
    <p class="cart_navigation required submit">
        ...
        {if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'htmlall':'UTF-8'}" />{/if}
        <input type="submit" name="submitAccount" id="submitAccount" value="{l s='Register'}" class="exclusive button radius" />
        <span><sup>*</sup>{l s='Required field'}</span>
    </p>
</form>
{/if}