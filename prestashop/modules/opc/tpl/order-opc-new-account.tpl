<div id="opc_new_account" class="opc-main-block">
	...
	<p class="onestepcheckout-numbers onestepcheckout-numbers-1">{l s='Account'}</p>
	<form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")}" method="post" id="login_form" class="std">
		<fieldset>
			...
			<div id="login_form_content" style="display:none;">
				...
				<div style="margin-left:40px;margin-bottom:5px;float:left;">
	...
	<form action="javascript:;" method="post" id="new_account_form" class="std" autocomplete="on" autofill="on">
		<fieldset>
			...
			<div id="opc_account_form">
				<p>
					<input type="button" class="exclusive_large" id="opc_back_to_create_or_guest" value="{l s='Return to choise lists' mod='opc'}" />
				</p>
				...
				<p class="radio required">
					<span class="left">{l s='Title'}</span>
				...
				<div  id="opc_delivery_address" class="is_customer_param">
					...
					<p class="textarea is_customer_param">
						...
						<textarea name="other" id="other" cols="36" rows="3"></textarea>
					</p>
					<p class="required text">
