                  ...
                  <li class="last">
                      <div id="search_bar" class="twelve mobile-three columns end">
                        <form method="get" action="{$link->getPageLink('search.php', true)}" id="searchbox">
                            ...
                            <input placeholder="{l s='חיפוש' mod='responsivelinks'}" class="search_query" type="text" id="search_query_block" name="search_query" value="{if isset($smarty.get.search_query)}{$smarty.get.search_query|htmlentities:$ENT_QUOTES:'utf-8'|stripslashes}{/if}" />
                        </form>
                      </div>
                  </li>
                </ul>
